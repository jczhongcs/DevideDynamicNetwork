...
data1 = pd.read_csv(r'E:\科研\ecoli_总结\dynamicNet\person\threshold\ecoliGeneExpression.csv')
data2 = pd.read_csv(r'E:\科研\ecoli_总结\dynamicNet\person\threshold\staticNet.csv')

timeData = data1.iloc[:, 1:9].values
...
data1.to_csv(r"E:\科研\动态网络切分参数选择\ecoli\p=5u=10\k=3\pw.csv", index=False)
